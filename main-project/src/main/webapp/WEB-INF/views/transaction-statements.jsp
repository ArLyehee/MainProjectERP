...
<td class="text-right"><fmt:formatNumber value="${s.totalAmount != null ? s.totalAmount : 0}" type="number" groupingUsed="true"/>원</td>
<td class="text-right"><fmt:formatNumber value="${s.taxAmount != null ? s.taxAmount : 0}" type="number" groupingUsed="true"/>원</td>
<td class="text-right" style="font-weight:600;"><fmt:formatNumber value="${s.grandTotal != null ? s.grandTotal : 0}" type="number" groupingUsed="true"/>원</td>
